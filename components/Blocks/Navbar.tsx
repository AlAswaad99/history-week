...
export default function Navbar() {
  return (
    <nav className={`fixed lg:px-20 px-4 top-0 z-50 py-4 bg-transparent backdrop-blur-sm text-white left-0 right-0 self-center flex justify-between rounded-b-3xl`}>
